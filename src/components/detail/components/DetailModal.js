...
const DetailModal = () => {
  ...
  const {
    ...
    children,
    rooms
  } = useSelector((state) => state.detail, shallowEqual);
  ...
  const MemberReviews = () => {
            ...
            <div className="media mr-2">
              ...
              <div className="media-body">
                <div className="reviews-members-header d-flex justify-content-between">
                  <div>
                    <h6 className="mb-1 font-weight-bold">{review.author}</h6>
                    <p className="font-weight-bold small text-secondary mb-1">
                      {review.date}
                    </p>
                  </div>
    ...
    return (<>
        ...
        <UncontrolledCollapse toggler="#reviewToggler">
          <Container className={"px-0"}>{collapseItems}</Container>
        </UncontrolledCollapse>
                ...
                >
                  <div className="bg-white rounded  mb-4 clearfix graph-star-rating">
                    <div className="graph-star-rating-header">
                      <h6
                        className="font-weight-bold text-muted d-flex justify-content-between my-4">
                        <span>
                          <Icon svg={STAR_RATE} />
                  ...
                  <div className="bg-white rounded mb-4 restaurant-detailed-ratings-and-reviews">
                    <h6 className="font-weight-bold text-secondary mb-1">
  ...
  const Rooms = () => {
    const roomDeals = ensureNonEmpty(deals).map((deal) => (<Row
        className={"room-deal my-4"}
        key={deal.title}
        onClick={() => startDate && endDate && openBooking({ deal, accommodation, deals })}
      >
        ...
        {startDate && endDate ? (<>
            <div className={"d-flex justify-content-between flex-row"}>
              ...
              <div className={"d-flex align-items-center"}>
                <Badge
                  className={"align-self-center p-1 px-2 mr-1"}
                  color={"grey"}
                >
                ...
                <Badge
                  className={"align-self-center p-1 px-2 ml-2 mr-1"}
                  color={"grey"}
                >
                  {guestsAmount}
                </Badge>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (guestsFocused === true) {
                          dispatch({
                            type: "SET_GUEST_AMOUNT", payload: {
                              adults: localAdults, children: localChildren, rooms: localRooms
                            }
                          });
            ...
            {deals.length === 0 ? (<Alert color="danger" className={"mt-3 mb-2 d-flex flex-column"}>
                No rooms were available for you selected dates, please re-select
                dates again
                <Button
              ...
              </Alert>) : (<Container>{roomDeals}</Container>)}
            {/*{deals}*/}
          </>) : (<>
            <div>
              <h4 className={"text-secondary mt-2"}>Rooms</h4>
              <Alert
                color="warning"
